      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-2xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-3-4a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0" />
              </svg>
              New Instructor
            </Link>
          </div>
          <p className="text-sm text-gray-400 mt-4">One sign-in automatically opens the right workspace.</p>
