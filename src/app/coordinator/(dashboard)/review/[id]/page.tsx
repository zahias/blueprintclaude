...
export default function CoordinatorReviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <Link href="/coordinator" className="text-teal-600 hover:text-teal-800 text-sm mb-4 inline-block">
              ...
              {blueprint.topics.map((bt) => (
                <tr key={bt.id}>
                  ...
                  <td className="px-4 py-2 text-center">
                    {bt.topic.los.map((l) => (
                      <span key={l.learningOutcomeId} className="bg-teal-100 text-teal-700 text-xs font-mono px-1 rounded mr-1">
